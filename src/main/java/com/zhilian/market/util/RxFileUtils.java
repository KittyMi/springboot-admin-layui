...
import static com.zhilian.market.util.RxConstUtils.KB;
...
public class RxFileUtils {
     ...
     * @param files
     */
    public static void mergeFiles(File outFile, List<File> files) {
     ...
     * @return
     */
    public static String getNativeM3u(File file, List<File> pathList) {
        InputStream in = null;
        int num = 0;
        //需要生成的目标buff
