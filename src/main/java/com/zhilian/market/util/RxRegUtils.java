...
import static com.zhilian.market.util.RxConstUtils.*;
import static com.zhilian.market.util.RxDataUtils.isNullString;
...
public class RxRegUtils {
     ...
     * @return
     */
    public static String extractCodeFromSms(String smsBody){
