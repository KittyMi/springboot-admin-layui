...
import static com.zhilian.market.util.RxDataUtils.bytes2HexString;
import static com.zhilian.market.util.RxDataUtils.hexString2Bytes;
...
public class RxEncryptUtils {
     ...
     * @return Base64密文
     */
//    public pstatic byte[] encryptDES2Base64(byte[] data, byte[] key) {
...
//    }
     ...
     * @return 明文
     */
//    public pstatic byte[] decryptBase64DES(byte[] data, byte[] key) {
...
//    }
     ...
     * @return Base64密文
     */
//    public pstatic byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
...
//    }
     ...
     * @return 明文
     */
//    public pstatic byte[] decryptBase64_3DES(byte[] data, byte[] key) {
...
//    }
     ...
     * @return Base64密文
     */
//    public pstatic byte[] encryptAES2Base64(byte[] data, byte[] key) {
...
//    }
     ...
     * @return 明文
     */
//    public pstatic byte[] decryptBase64AES(byte[] data, byte[] key) {
